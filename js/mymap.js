...
* get from database
*****************************************************/
var allTypes = ["Novo mobiliário",
				"Sem demarcação",
				"Chapéu chinês",
				"Placa em cano",
				"Estação tubo",
				"Domus",
				"Especial Madrugueiro",
				"Plataforma",
				"Placa em poste",
				"Concreto",
				"Linha Turismo",
...
function showNegocios () {
	...
	$('#tipo-container button').text(allSelected ? 'Todos seleccionados' : 'Selecionar categoria');
}
...
function executeFilter(){
	...
	setMarkers(filterData(bairro, types, ano, allSelected));
	setPolygons();
}
